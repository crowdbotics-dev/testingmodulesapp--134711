...
const testingmodulesappAPI = axios.create({
  baseURL: "https://testingmodulesapp--134711.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_docs_schema_retrieve(payload) {
  return testingmodulesappAPI.get(`/api-docs/schema/`, {
    params: { lang: payload.lang }
  })
}
function api_v1_login_create(payload) {
  return testingmodulesappAPI.post(`/api/v1/login/`, payload)
}
function api_v1_signup_create(payload) {
  return testingmodulesappAPI.post(`/api/v1/signup/`, payload)
}
function modules_two_factor_authentication_enable_2fa_retrieve(payload) {
  return testingmodulesappAPI.get(
    `/modules/two-factor-authentication/enable/2fa`
  )
}
function modules_two_factor_authentication_enable_2fa_create(payload) {
  return testingmodulesappAPI.post(
    `/modules/two-factor-authentication/enable/2fa`
  )
}
function modules_two_factor_authentication_enable_2fa_destroy(payload) {
  return testingmodulesappAPI.delete(
    `/modules/two-factor-authentication/enable/2fa`
  )
}
...
function rest_auth_login_create(payload) {
  return testingmodulesappAPI.post(`/rest-auth/login/`, payload)
}
function rest_auth_logout_create(payload) {
  return testingmodulesappAPI.post(`/rest-auth/logout/`)
}
function rest_auth_password_change_create(payload) {
  return testingmodulesappAPI.post(`/rest-auth/password/change/`, payload)
}
function rest_auth_password_reset_create(payload) {
  return testingmodulesappAPI.post(`/rest-auth/password/reset/`, payload)
}
...
function rest_auth_registration_create(payload) {
  return testingmodulesappAPI.post(`/rest-auth/registration/`, payload)
}
...
function rest_auth_user_retrieve(payload) {
  return testingmodulesappAPI.get(`/rest-auth/user/`)
}
function rest_auth_user_update(payload) {
  return testingmodulesappAPI.put(`/rest-auth/user/`, payload)
}
function rest_auth_user_partial_update(payload) {
  return testingmodulesappAPI.patch(`/rest-auth/user/`, payload)
}
